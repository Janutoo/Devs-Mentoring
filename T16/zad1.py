...
multiprocessing = timeit.timeit(multithreading_sort(sample_arrays), number=1)
print(f"Czas wykonania z threading: {multiprocessing:.6f} sekund")

threading = timeit.timeit(measure_threading(sample_arrays), number=1)
print(f"Czas wykonania z threading: {threading:.6f} sekund")
